        ...
        <div class = "main">
            ...
            <div class = "content">
               ...
               <br>
            	...
            	<br>
            	<br>
                <form name="send" id="send" method="post" action="finisheditwa.php" enctype="multipart/form-data" >	
            	<table align="center" cellpadding = "5">
                  ...
                  <tr>
                    ...
                    <tr>
                      ...
                      <td><input type="hidden" name="MAX_FILE_SIZE" value="500000" /><input name="pic" type="file" id="pic"><font size='2' color='red'>[大小不超过300kb]</font></td>
                    </tr>
