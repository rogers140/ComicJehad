            ...
            <div class = "content">
               ...
               <br>
                ...
                <tr><td colspan="2" align="center">带<font color="#ff6699">*</font>为必填项</td></tr>
                    ...
                    <tr>
                        <td>负责人：</td>
                        <td><input name="thename" type="text" id="thename"><font color="#FF6699">*</font></td>
                    </tr>
                      <tr>
                         <td>社团头像上传</td>
                         
                         <td><input type="hidden" name="MAX_FILE_SIZE" value="300000" /><input name="thepic" type="file" id="thepic"></td>
                    ...
                    <tr>
                        ...
                        <td>	
                            <span>
								我已阅读并接受
							<a target="_blank" href="../resource/info.doc">《ComicJehad用户协议》</a>
							</span>
                        </td> 
                    </tr>
            		<tr>
